...
1,4,26,16,false,rom/programs/lua
	...
	local otherHTTPs = {"https://raw.githubusercontent.com/MargreetH/windowTryout/master/scripts/functions.lua",

"https://raw.githubusercontent.com/MargreetH/windowTryout/master/data/fingerprints.lua",
"https://raw.githubusercontent.com/MargreetH/windowTryout/master/turtle/spawnWithers.lua"}

	local otherpaths = {"/git/scripts", "/git/data", "/git"}
	local fileName = {"functions", "fingerprints", "spawnWithers"}
